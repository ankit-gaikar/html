    ...
    <div class="hsc-grid">
        <div class="hsc-inner content" >
            <div class="box-border">
                ...
                <p style="text-align: center;">We will contact you shortly to discuss the sale of your home and schedule your free home evaluation and staging consultation.</p>
            </div>
        </div>
    </div>
...
if(isset($_POST['submit'])) {
    ...
    $email_from = 'rahul@wsiestrategies.com';
    ...
    echo 'Reach';
    /*if(mail('webdev@wsiestrategies.com', 'Test','Test')){echo 'Test';} */
    ...
    $from1 = "Sophie Goudreau  <rahul@wsiestrategies.com>";
    ...
    //$headers1  = 'From: <rahul@wsiestrategies.com>' . "\r\n";
    ...
    We will contact you shortly to discuss the sale of your home and schedule your free home evaluation and staging consultation.</p>";
